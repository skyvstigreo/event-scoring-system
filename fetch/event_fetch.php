...
foreach ($result as $row) {
    ...
    $sub_array[] = '<center><button type="button" name="view" id="'.$row["event_id"].'" class="btn btn-primary btn-xs view"  data-toggle="tooltip" data-placement="bottom" title="View Event"><i class="fa fa-eye"></i></button> <button type="button" name="update" id="'.$row["event_id"].'" class="btn btn-primary btn-xs update" data-toggle="tooltip" data-placement="bottom" title="Edit Category"><i class="fa fa-edit"></i></button> <button type="button" name="delete" id="' . $row["event_id"] . '" class="btn btn-danger btn-xs delete" data-toggle="tooltip" data-placement="bottom" title="Remove User"><i class="fa fa-trash"></i></button>';
    $data[] = $sub_array;
}
...
{
    $statement = $connect->prepare("SELECT * FROM table_event");
    $statement->execute();
